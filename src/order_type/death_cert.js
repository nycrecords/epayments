        ...
        return(
            <div className="-order-modals">
                ...
                <div className="-row">
                    ...
                    <div className="-two-thirds">
                        {this.props.order_info["metadata"]["cemetery"] ? this.props.order_info["metadata"]["cemetery"]: "n/a"}
                    </div>
                </div>
                ...
                <div className="-row">
                    ...
                    <div className="-two-thirds">
                        {this.props.order_info["metadata"]["birth_place"] ? this.props.order_info["metadata"]["death_place"]  : "n/a"}
                    </div>
                </div>
