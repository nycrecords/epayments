...
def validate_additional_years(form, field):
    if field.data is not None and field.data != "":
        ...
        additional_years = ''.join(form.additional_years.data.split()).split(",")
...
class BirthCertificateForm(FlaskForm):
    ...
    num_copies = IntegerField("Number of Copies",
                              validators=[InputRequired("Number of copies is required."),
                                          validators.NumberRange(min=1, max=99)])
    status = SelectField("Status", choices=suborder_form.ORDER_STATUS)
    certificate_num = StringField("Certificate Number",
                                  validators=[InputRequired("Certificate Number is required."),
...
class MarriageCertificateForm(FlaskForm):
    ...
    bride_last_name = StringField("Last Name of Bride",
                                  validators=[InputRequired("Last Name of bride is required."),
    ...
    groom_last_name = StringField("Last Name of Groom",
                                  validators=[InputRequired("Last Name of groom is required."),
                                              validators.Length(max=25)])
...
class PhotoGalleryForm(FlaskForm):
    ...
    image_identifier = StringField("Image Identifier",
                                   validators=[InputRequired("Image Identifier is required."),
...
class TaxPhotoForm(FlaskForm):
    ...
    borough = SelectField("Borough",
                          choices=suborder_form.BOROUGHS, validators=[InputRequired("Borough is required.")])
    ...
    building_num = IntegerField("Building Number",
                                validators=[InputRequired("Building Number is required."),
                                            validators.NumberRange(min=1)])
